...
if choice == "investment":
    ...
    if interest == "simple":
        ...
        print(f"\nDear {name}!,\nYour investment of £{investment_amount} will be worth £{interest_sim:.2f} at {interest_rate}% after {investment_years} years of {interest} interest.")
    elif interest == "compound":
        interest_com = investment_amount * pow((1 + interest_rate/100), investment_years)
        print(f"\nDear {name}!,\nYour investment of £{investment_amount} will be  n  worth £{interest_com:.1f} at {interest_rate}% after {investment_years} year(s) of {interest} interest.")
    else:
    ...
    print(f"\nDear {name}!,\nThe monthly repayment for your home loan which is currently valued at £{home_present_value} is £{monthly_repayment:.1f} at {bond_interest_rate}% for the next {bond_months}months")
